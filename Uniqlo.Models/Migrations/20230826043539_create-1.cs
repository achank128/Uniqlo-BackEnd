        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Max = table.Column<decimal>(type: "money", nullable: true),
                    TotalFrom = table.Column<decimal>(type: "money", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromoPrice = table.Column<decimal>(type: "money", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_GenderTypes_GenderTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sizes_GenderTypes_GenderTypeId",
                        column: x => x.GenderTypeId,
                        principalTable: "GenderTypes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductReviewId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_ProductReviews_ProductReviewId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImportBills_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ImportBills_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Total = table.Column<decimal>(type: "money", nullable: false),
                    VATIncluded = table.Column<decimal>(type: "money", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditCardDate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreditCardNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreditCardNumberDisplay = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<int>(type: "int", nullable: false),
                    ShipmentPay = table.Column<decimal>(type: "money", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ImportBillItems",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ImportBillId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductDetailId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImportBillItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImportBillItems_ImportBills_ImportBillId",
                        column: x => x.ImportBillId,
                        principalTable: "ImportBills",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ImportBillItems_ProductDetails_ProductDetailId",
                        column: x => x.ProductDetailId,
                        principalTable: "ProductDetails",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_GenderTypeId",
                table: "Categories",
                column: "GenderTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_CollectionPosts_CollectionId",
                table: "CollectionPosts",
                column: "CollectionId");

            migrationBuilder.CreateIndex(
                name: "IX_ImportBillItems_ImportBillId",
                table: "ImportBillItems",
                column: "ImportBillId");

            migrationBuilder.CreateIndex(
                name: "IX_ImportBillItems_ProductDetailId",
                table: "ImportBillItems",
                column: "ProductDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_ImportBills_StoreId",
                table: "ImportBills",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_ImportBills_UserId",
                table: "ImportBills",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ProductReviewId",
                table: "Products",
